Pod::Spec.new do |s|
  ...
  s.description      = 'Minfo SDK with native AudioQR detection using Cifrasoft libraries.'
  ...
  # Framework Cifrasoft uniquement
  s.vendored_frameworks = 'Frameworks/SCSTB.framework'
