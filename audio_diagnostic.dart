...
class _AudioDiagnosticState extends State<AudioDiagnostic> {
  ...
  Future<void> _simulateSignal() async {
    _addLog("🧪 Simulation d'un signal...");
    
    // Simuler un appel depuis le natif
    await platform.invokeMethod('onSignalDetected', {
      'type': 'SoundCode',
      'codes': '12345_67890'
    });
  }
